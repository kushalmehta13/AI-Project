...
from agent import DcrawlerAgent
...
def main(args):
    ...
    agent = DcrawlerAgent(args.height, args.width, args.initial_strength)#RandomAgent(args.height, args.width, args.initial_strength)
