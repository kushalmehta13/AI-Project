...
def surrounding_spaces(curr, maxlen):
    ...
    # South East Neighbor
    if x + 1 <= maxlen - 1 and y + 1 <= maxlen - 1 and not (
            get_tile(observable, 's') == get_tile(observable, 'e') == 'w'):
...
def deadend(current, explored):
    ...
    count = 0
    if 'e' not in observableTiles or get_tile(observableTiles, 'e') == 'w' or explored[
        observableTiles['e']] == math.inf:
        count += 1
    if 'w' not in observableTiles or get_tile(observableTiles, 'w') == 'w' or explored[
        observableTiles['w']] == math.inf:
        count += 1
    if 'n' not in observableTiles or get_tile(observableTiles, 'n') == 'w' or explored[
        observableTiles['n']] == math.inf:
        count += 1
    if 's' not in observableTiles or get_tile(observableTiles, 's') == 'w' or explored[
        observableTiles['s']] == math.inf:
        count += 1
